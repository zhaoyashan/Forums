(function(a) {
    a.fn.waterfallindex = function(o, g, j) {
        var i = this;
        if (i.length <= 0) {
            return
        }
        ...
        var c = a.extend({},a.fn.waterfallindex.defaults, j);
        c.fn = o;
        var k,r = [];
        var q = !!g;
...
jQuery(function() {
    jQuery("#waterfallindex").waterfallindex("div.dym-dl", {index: 3})
});