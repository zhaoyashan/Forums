...
0
|| checktplrefresh('./template/artery_2013_06/common/header.htm', './template/default/common/header_common.htm', 1374376465, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/artery_2013_06', 'common/header_home_spacecp')
|| checktplrefresh('./template/artery_2013_06/common/header.htm', './template/default/common/header_qmenu.htm', 1374376465, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/artery_2013_06', 'common/header_home_spacecp')
|| checktplrefresh('./template/artery_2013_06/common/header.htm', './template/default/common/pubsearchform.htm', 1374376465, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/artery_2013_06', 'common/header_home_spacecp')
;?>
...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?> - <?php } if(empty($nobbname)) { ?> <?php echo $_G['setting']['bbname'];?> - <?php } ?> Powered by 晟点科技</title>
...
<?php } } } ?>
                ...
                <?php echo adshow("headerbanner");?><?php echo adshow("subnavbanner/a_mu");?><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<?php } ?>
<script src="<?php echo IMGDIR;?>/jquery-1.4.2.min.js" type="text/javascript"></script>
<div class="pagewhitebox">
<?php if($_G['basescript'] == portal && CURMODULE == index) { } else { ?>
<div id="wp" class="wp">
    <?php } ?>
